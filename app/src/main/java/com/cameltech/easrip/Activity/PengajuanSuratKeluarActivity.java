...
public class PengajuanSuratKeluarActivity extends AppCompatActivity {
    ...
    EditText tvStatus, tvTanggal, tvLampiran, tvPerihal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvStatus = (EditText) findViewById(R.id.sttsValid);
            ...
            simpan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!isEmpty(tvNamaDok.getText().toString()) && !isEmpty(tvNoDok.getText().toString())
                        ...
                        tambahBerkas(new SuratKeluar(tvEmail.getText().toString(), tvNoDok.getText().toString(), tvInstansi.getText().toString(), tvAlamatInstansi.getText().toString()
                                , tvLampiran.getText().toString(), tvPerihal.getText().toString(), tvTanggal.getText().toString()
                                , tvNamaDok.getText().toString(), tvStatus.getText().toString(), tvDeskripsi.getText().toString()));
                    } else
    ...
    void tambahBerkas(SuratKeluar arsip) {
