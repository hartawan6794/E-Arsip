    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (arsip != null) {
            ...
            if(kategori.equals("1")){
                actionBar.setTitle("Tambah Surat Masuk");
                kategoriSurat.setText("Surat Masuk");
            }if(kategori.equals("2")){
                actionBar.setTitle("Tambah Surat Keluar");
                kategoriSurat.setText("Surat Keluar");
            }
                ...
                public void onClick(View v) {
                    if (!isEmpty(tvNamaDok.getText().toString()) && !isEmpty(tvNoDok.getText().toString())
                        ...
                        tambahBerkas(new SuratMasuk(tvNoDok.getText().toString(), tvInstansi.getText().toString(), tvAlamatInstansi.getText().toString()
                                ...
                                , tvmapArsip.getText().toString(), tvNamaMapArsip.getText().toString(), kategoriSurat.getText().toString()));
                    } else
