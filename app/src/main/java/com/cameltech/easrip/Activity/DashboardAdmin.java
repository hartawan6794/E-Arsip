    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnCounrArsip:
                if (alias.equals("amel.021297@gmail.com") || alias.equals("amel.021297@gmail.com")) {
                    startActivity(new Intent(DBReadArsipActivity.getActIntent(DashboardAdmin.this)));
                } else {
                    startActivity(new Intent(DBReadArsipPenggunaActivity.getActIntent(DashboardAdmin.this)));
                }
                break;
            case R.id.btnCounrPengguna:
                if (userAlias.equals("Admin")) {
                    startActivity(new Intent(DBReadPenggunaActivity.getActIntent(this)));
                } else {
