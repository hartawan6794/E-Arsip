...
public class DaftarPengajuanSuratKeluar extends AppCompatActivity implements AdapterDaftarSuratKeluar.FirebaseDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_pengajuan_surat_keluar);
        ...
        databaseReference.child("SuratKeluar").orderByChild("namaSurat").startAt(hasil).endAt(hasil + "\uf8ff").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getValue() == null) {
                    ...
                    adapter = new AdapterDaftarSuratKeluar(DaftarPengajuanSuratKeluar.this, suratKeluars);
    ...
    public static Intent getActIntent(Activity activity) {
        ...
        return new Intent(activity, DaftarPengajuanSuratKeluar.class);
    }

    @Override
    public void onDeleteData(SuratKeluar arsip, int position) {
        if (databaseReference != null) {
            databaseReference.child("SuratKeluar").child(arsip.getKey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
