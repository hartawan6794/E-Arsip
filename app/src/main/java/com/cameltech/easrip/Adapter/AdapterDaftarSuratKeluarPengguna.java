...
public class AdapterDaftarSuratKeluarPengguna extends RecyclerView.Adapter<AdapterDaftarSuratKeluarPengguna.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        if(status.equals("0")){
            holder.tvStatus.setText("Menunggu Persetujuan Sekertaris");
            holder.tvStatus.setTextColor(ContextCompat.getColor(context,R.color.colorStatusRed));
        }
        if(status.equals("1")){
        ...
        if(status.equals("2")){
            ...
            holder.tvStatus.setTextColor(ContextCompat.getColor(context,R.color.colorStatusGreen));
        }
